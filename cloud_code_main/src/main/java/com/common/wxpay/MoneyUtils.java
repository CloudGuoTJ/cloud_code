...
public class MoneyUtils {
    private static String partner = "1318442301";// 微信支付商户号
     ...
     */
    public static String createSign(String partnerkey, Map<String, Object> map) {
    ...
    public static String doSendMoney(String certName, String partnerkey, String url, String data) throws Exception {
        //FileInputStream instream = new FileInputStream(new File("E:\\work\\credentials\\ymdm\\apiclient_cert.p12"));//用来本地测试
        FileInputStream instream = new FileInputStream(new File(certName));
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        try {
            keyStore.load(instream, partnerkey.toCharArray());//这里写密码..默认是你的MCHID
        } catch (Exception e) {
        	e.printStackTrace();
		} finally {
            instream.close();
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, partnerkey.toCharArray())//这里也是写密码的
                .build();
